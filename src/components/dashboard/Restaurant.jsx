...
//     if (!form.ownerId) return toast.error("ownerId is required");
...
//           <div className="mt-6">
//             <label className="block text-sm text-white/80 mb-2">
//               Restaurant Owner <span className="text-amber-400">*</span>
//             </label>
...
//                 value={form.ownerId}
//                 onChange={handleChange}
//                 className="w-full appearance-none rounded-xl bg-zinc-950/60 border border-white/10 px-4 py-3 pr-10 text-white outline-none focus:border-amber-400/60 focus:ring-2 focus:ring-amber-400/15"
//               >
...
//               Required fields: Name, Email, Owner, Address, Logo
//             </p>
//           </div>
//         </form>
//       </div>
